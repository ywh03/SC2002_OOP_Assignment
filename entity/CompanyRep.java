...
public class CompanyRep extends User{
    ...
    public int getNumOfInternships(){
        return this.numOfInternships;
    }

    public void setNumOfInternships(int numOfInternships){
    ...
    public ArrayList<Internship> getInternshipInfo(){
        return this.internshipInfo;
    }
